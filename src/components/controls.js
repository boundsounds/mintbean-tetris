...
class Controls extends Component {
  ...
  render() {
    ...
    const controlButton = (onClick, icon, title) => {
      return (
        <button
          className="control-button not-selectable"
          title={title}
          onClick={(e) => {
            onClick(e);
          }}
    ...
    return (
      <div className="controls">
        ...
        {controlButton(
          moveLeft,
          { url: leftArrow, alt: "Left Arrow Symbol" },
          "Left Key"
        )}
        ...
        {controlButton(
          moveRight,
          { url: rightArrow, alt: "Right Arrow Symbol" },
          "Right Key"
        )}
        ...
        {controlButton(
          rotate,
          { url: rotateIcon, alt: "Rotate Arrow Symbol" },
          "Up/Down Key"
        )}

        {/* down */}
        <button className="control-button" title="Space Bar" onClick={moveDown}>
          <img alt="Move Down Arrow" src={downArrow} />
        </button>
      </div>
    );
  }
